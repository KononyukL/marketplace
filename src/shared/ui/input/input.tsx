    ...
    <>
      ...
      >
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            "placeholder:text-grayText border-blue-2 w-full  rounded border  px-2.5 py-2 font-light text-secondary placeholder:font-light focus:border-2 focus:border-secondary-light focus:outline-none focus:ring-0  focus-visible:outline-none",
