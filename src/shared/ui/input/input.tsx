    ...
    <>
      ...
      >
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            " placeholder:text-grayText text-input border-input-2  w-full  rounded border px-2.5 py-2 font-light placeholder:font-light focus:border-2 focus:outline-none focus:ring-0  focus-visible:outline-none",
            error &&
              "focus-visible:shadow-input border-2 border-error focus-visible:border-error ",
            type !== "checkbox" &&
